...
(* OASIS_START *)
(* DO NOT EDIT (digest: 46d44c7805356f7307b852430285ed41) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Nate Foster"];
          homepage = None;
          synopsis = "The Boomerand Regular Expression Library";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "h\232\166\186P\003\250`\236\139o\0282\175;\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
